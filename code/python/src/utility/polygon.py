...
def enlarge_polygon(old_points, offset):
    ...
    for j in range(num_points):
        ...
        v1 = np.array([old_points[j][0] - old_points[i][0], old_points[j][1] - old_points[i][1]], np.float32)
        ...
        v2 = np.array([old_points[k][0] - old_points[j][0], old_points[k][1] - old_points[j][1]], np.float32)
